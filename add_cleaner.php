...
<main class="page-content" >
    <div class="container-fluid" >
        ...
        <div class="d-flex justify-content-between mt-4">
           <h5> <img src="img/p5.png" alt="" class="icns1"><span> ADD CLEANER</span></h5>
        </div>
        <div class="row">
                ...
                <form action="submit_driver.php" method="post" enctype="multipart/form-data" style="background-color:rgba(255, 255, 255, 0.4)" >
                    ...
                    <div class="row mt-2">
                        <div class="group-form col-md-6">
                            ...
                            <input type="text"  value="" class="form-control form-control-sm" id="fname" required name="fname" placeholder="Enter First Name">
                        </div>

                        <div class="group-form col-md-6">
                            <label class="form_label" for="company_name"> Last Number</label>
                            <input type="text"  value="" class="form-control form-control-sm" id="lname" required name="lname" placeholder="Enter Last Name">
                        </div>
                    </div></br>
                    ...
                    <div class="row mt-2">
                        <div class="group-form col-md-6">
                            ...
                            <input type="text"  value="" class="form-control form-control-sm" id="mobile1" required name="mobile1" placeholder="Enter Mobile Number">
                        </div>

                        <div class="group-form col-md-6">
                            <label class="form_label" for="company_name">Secondary Moble Number</label>
                            <input type="text"  value="" class="form-control form-control-sm" id="mobile2" required name="mobile2" placeholder="Enter Mobile Number">
                        </div>
                        </div></br>
                    ...
                    <div class="row mt-2">
                        <div class="group-form col-md-6">
                            ...
                            <input type="text"  value="" class="form-control form-control-sm" id="adds" required name="adds" placeholder="Enter Your Current Address">
                        </div>

                        <div class="group-form col-md-6">
                            <label class="form_label" for="company_name">Joining Date</label>
                            <input type="date"  value="" class="form-control form-control-sm" id="date" required name="date" placeholder="mm/dd/yyyy">
                        </div>
                    </div></br>
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="group-form col-md-3">
                            ...
                            <input type="hidden"  value="cleaner" id="driver" name="driver">
                        </div>
                    </div><br>
